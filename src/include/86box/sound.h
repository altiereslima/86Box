...
extern void sound_main_thread_init(void);
extern void sound_main_thread_end(void);

extern void wavetable_main_thread_init(void);
extern void wavetable_main_thread_end(void);
